...
ogre_team = ctrl.Antecedent(np.arange(0, 101, 1), 'ogre_team')
goblin_team = ctrl.Antecedent(np.arange(0, 101, 1), 'goblin_team')
troll_team = ctrl.Antecedent(np.arange(0, 101, 1), 'troll_team')
ogre_enemy_goblin = ctrl.Antecedent(np.arange(0, 101, 1), 'ogre_enemy_goblin')
goblin_enemy_ogre = ctrl.Antecedent(np.arange(0, 101, 1), 'goblin_enemy_ogre')
troll_enemy_goblin = ctrl.Antecedent(np.arange(0, 101, 1), 'troll_enemy_goblin')
ogre_enemy_troll = ctrl.Antecedent(np.arange(0, 101, 1), 'ogre_enemy_troll')
goblin_enemy_troll = ctrl.Antecedent(np.arange(0, 101, 1), 'goblin_enemy_troll')
troll_enemy_ogre = ctrl.Antecedent(np.arange(0, 101, 1), 'troll_enemy_ogre')
...
goblin_team['small'] = fuzz.trapmf(goblin_team.universe,[2, 10, 30, 40])
goblin_team['medium'] = fuzz.trapmf(goblin_team.universe,[30, 40, 60, 70])
goblin_team['large'] = fuzz.trapmf(goblin_team.universe,[60,70,90,100])

ogre_team['one'] = fuzz.trapmf(ogre_team.universe,[0,0, 1, 2])
ogre_team['small'] = fuzz.trapmf(ogre_team.universe,[2, 10, 30, 40])
ogre_team['medium'] = fuzz.trapmf(ogre_team.universe,[30, 40, 60, 70])
ogre_team['large'] = fuzz.trapmf(ogre_team.universe,[60,70,90,100])

troll_team['one'] = fuzz.trapmf(troll_team.universe,[0,0, 1, 2])
troll_team['small'] = fuzz.trapmf(troll_team.universe,[2, 10, 30, 40])
troll_team['medium'] = fuzz.trapmf(troll_team.universe,[30, 40, 60, 70])
troll_team['large'] = fuzz.trapmf(troll_team.universe,[60,70,90,100])

ogre_enemy_goblin['one'] = fuzz.trapmf(ogre_enemy_goblin.universe,[0,0, 1, 2])
ogre_enemy_goblin['small'] = fuzz.trapmf(ogre_enemy_goblin.universe,[2, 10, 30, 40])
ogre_enemy_goblin['medium'] = fuzz.trapmf(ogre_enemy_goblin.universe,[30, 40, 60, 70])
ogre_enemy_goblin['large'] = fuzz.trapmf(ogre_enemy_goblin.universe,[60,70,90,100])

goblin_enemy_ogre['one'] = fuzz.trapmf(goblin_enemy_ogre.universe,[0,0, 1, 2])
goblin_enemy_ogre['small'] = fuzz.trapmf(goblin_enemy_ogre.universe,[2, 10, 30, 40])
goblin_enemy_ogre['medium'] = fuzz.trapmf(goblin_enemy_ogre.universe,[30, 40, 60, 70])
goblin_enemy_ogre['large'] = fuzz.trapmf(goblin_enemy_ogre.universe,[60,70,90,100])

troll_enemy_goblin['one'] = fuzz.trapmf(troll_enemy_goblin.universe,[0,0, 1, 2])
troll_enemy_goblin['small'] = fuzz.trapmf(troll_enemy_goblin.universe,[2, 10, 30, 40])
troll_enemy_goblin['medium'] = fuzz.trapmf(troll_enemy_goblin.universe,[30, 40, 60, 70])
troll_enemy_goblin['large'] = fuzz.trapmf(troll_enemy_goblin.universe,[60,70,90,100])

ogre_enemy_troll['one'] = fuzz.trapmf(ogre_enemy_troll.universe,[0,0, 1, 2])
ogre_enemy_troll['small'] = fuzz.trapmf(ogre_enemy_troll.universe,[2, 10, 30, 40])
ogre_enemy_troll['medium'] = fuzz.trapmf(ogre_enemy_troll.universe,[30, 40, 60, 70])
ogre_enemy_troll['large'] = fuzz.trapmf(ogre_enemy_troll.universe,[60,70,90,100])

goblin_enemy_troll['one'] = fuzz.trapmf(goblin_enemy_troll.universe,[0,0, 1, 2])
goblin_enemy_troll['small'] = fuzz.trapmf(goblin_enemy_troll.universe,[2, 10, 30, 40])
goblin_enemy_troll['medium'] = fuzz.trapmf(goblin_enemy_troll.universe,[30, 40, 60, 70])
goblin_enemy_troll['large'] = fuzz.trapmf(goblin_enemy_troll.universe,[60,70,90,100])

troll_enemy_ogre['one'] = fuzz.trapmf(troll_enemy_ogre.universe,[0,0, 1, 2])
troll_enemy_ogre['small'] = fuzz.trapmf(troll_enemy_ogre.universe,[2, 10, 30, 40])
troll_enemy_ogre['medium'] = fuzz.trapmf(troll_enemy_ogre.universe,[30, 40, 60, 70])
troll_enemy_ogre['large'] = fuzz.trapmf(troll_enemy_ogre.universe,[60,70,90,100])
